...
DEFAULT_SHOP_MTPROTO_HOST = "mtproxy.proxycraft.tech"
...
DEFAULT_SHOP_MTPROTO_FAST_MODE = True
...
DEFAULT_AWG_SERVER_PUBLIC_IP = "0.0.0.0"
...
DEFAULT_SHOP_WHATSAPP_PUBLIC_PORT = 443
DEFAULT_SHOP_WHATSAPP_PORT_MIN = 10001
DEFAULT_SHOP_WHATSAPP_PORT_MAX = 10999
DEFAULT_SHOP_WHATSAPP_HAPROXY_CONFIG_PATH = "/app/whatsapp-runtime/haproxy.cfg"
...
class ShopConfig:
    ...
    MTPROTO_MASK_PORT: int
    MTPROTO_FAST_MODE: bool
    ...
    WHATSAPP_HOST: str
    WHATSAPP_LOCATION: str
    WHATSAPP_PUBLIC_PORT: int
...
def load_config() -> Config:
    ...
    return Config(
        ...
        shop=ShopConfig(
            ...
            MTPROTO_LOCATION=env.str(
                "SHOP_MTPROTO_LOCATION", default=DEFAULT_SHOP_MTPROTO_LOCATION
            ),
            ...
            MTPROTO_MASK_HOST=env.str(
                "SHOP_MTPROTO_MASK_HOST", default=DEFAULT_SHOP_MTPROTO_MASK_HOST
            ),
            MTPROTO_MASK_PORT=env.int(
                "SHOP_MTPROTO_MASK_PORT", default=DEFAULT_SHOP_MTPROTO_MASK_PORT
            ),
            MTPROTO_FAST_MODE=env.bool(
                "SHOP_MTPROTO_FAST_MODE", default=DEFAULT_SHOP_MTPROTO_FAST_MODE
            ),
            ...
            WHATSAPP_LOCATION=env.str(
                "SHOP_WHATSAPP_LOCATION", default=DEFAULT_SHOP_WHATSAPP_LOCATION
            ),
            WHATSAPP_PUBLIC_PORT=env.int(
                "SHOP_WHATSAPP_PUBLIC_PORT", default=DEFAULT_SHOP_WHATSAPP_PUBLIC_PORT
            ),
