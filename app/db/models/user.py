...
class User(Base):
    ...
    legal_consents_version: Mapped[Optional[str]] = mapped_column(String(32), nullable=True)
    privacy_policy_accepted_at: Mapped[datetime | None] = mapped_column(nullable=True, default=None)
    terms_of_use_accepted_at: Mapped[datetime | None] = mapped_column(nullable=True, default=None)
    personal_data_consent_accepted_at: Mapped[datetime | None] = mapped_column(nullable=True, default=None)
    marketing_consent_granted: Mapped[bool] = mapped_column(default=False, nullable=False)
    marketing_consent_updated_at: Mapped[datetime | None] = mapped_column(nullable=True, default=None)
